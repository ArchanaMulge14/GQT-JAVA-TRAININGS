...
class Test{
	...
	void display2() {
		...
		System.out.println(a+"----"+b+"----"+c);//we can access static variables in non-static block
	}
}

public class StaticLaunch1 {
	public static void main(String[] args) {
		System.out.println("Before object creation and before value assignment"+Test.a+"---"+Test.b+"---"+Test.c);
		Test.a=1001;
		Test.b=2001;
		Test.c=3001;
		Test.display();
